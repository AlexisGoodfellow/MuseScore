...
static muse::testing::SuiteEnvironment editude_se(
{
    ...
    nullptr,
    []() {
    mu::engraving::ScoreRW::setRootPath(muse::String::fromUtf8(editude_tests_DATA_ROOT));
    ...
    // [editude] isAccessibleEnabled() left IEngravingConfiguration upstream.
