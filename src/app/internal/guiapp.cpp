...
{
    // [editude] The web appshell registers Main.qml in its own QRC, not under
    // the platform/ hierarchy that the native shells use.
#ifdef Q_OS_WASM
    UNUSED(platform);
    return QStringLiteral(":/qml/Main.qml");
#else
